...
function adminLogin() {
    ...
    if (username === "udhaysachin" && password === "9373") {
      ...
      <body>
        <div class="result-container">
          ...
          <table>
            ...
            <tr><td>Maths</td><td>${student.sub1}</td></tr>
            <tr><td>English</td><td>${student.sub2}</td></tr>
            <tr><td>Computer</td><td>${student.sub3}</td></tr>
            <tr><td>Science</td><td>${student.sub4}</td></tr>
            <tr><td>Hindi</td><td>${student.sub5}</td></tr>
          </table>
